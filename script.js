...
<head>
  ...
  <title>LixStaff – Évaluation annuelle</title>
  <link rel="stylesheet" href="style.css" />
</head>
<body data-type="annuelle">
  <header>
    <h1>LixStaff – Évaluation annuelle</h1>
  </header>
  ...
  <script src="ouvriers.js?v=2"></script>
  <script src="https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js" crossorigin="anonymous"></script>
  <script src="script.js"></script>

  <!-- Shim : si window.OUVRIERS est déjà là, on remplit tout de suite -->
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      if (window.OUVRIERS && Array.isArray(window.OUVRIERS) && window.OUVRIERS.length) {
